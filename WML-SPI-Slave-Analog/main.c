	...
	while (1) {
		...
		//switch(SPDR){
		  ...
		  //case 0b10000010 : channel=1; break;
			...
			case 0b10000100 : ReadADC(1); DataADCH(1); break;
			case 0b10001000 : ReadADC(2); DataADCH(2); break;
			case 0b01000010 : //HEX=0x42
							  USARTPutNum(DataADCL(0)); USARTPutStr("\n\r"); break;
			case 0b01000100 : ReadADC(1); DataADCL(1); break;
			case 0b01001000 : ReadADC(2); DataADCL(2); break;
		  //case 0b00100010 : ReadADC(0); DigitalRAW(0); break;
			case 0b00100000 : USARTPutNum(DigitalRAW(0));USARTPutNum(DigitalRAW(1));
